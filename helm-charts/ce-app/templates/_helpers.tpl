...
{{- if .Values.global.ceApp.imageLibrary -}}
{{- .Values.global.ceApp.imageLibrary -}}/
{{- end -}}
{{- .Values.global.ceApp.imageName -}}:{{- .Values.global.ceApp.imageTag -}}
{{- end -}}
...
Common labels
*/}}
{{- define "ce-app.labels" -}}
app.kubernetes.io/name: {{ include "ce-app.name" . }}
helm.sh/chart: {{ include "ce-app.chart" . }}
