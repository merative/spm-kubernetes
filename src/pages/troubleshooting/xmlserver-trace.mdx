...
XML server tracing is described in the [Debug configuration](https://www.ibm.com/docs/en/spm/8.0.2?topic=server-debug-configuration) topic of the SPM product documentation.
...
To enter the commands in this topic as-is you need to enter the following commands first, substituting `<name_space>` for the OpenShift project name or IKS namespace for your dpeloyment:
