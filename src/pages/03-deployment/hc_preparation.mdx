...
To use the Helm Charts to install SPM on Minikube, package the charts and load them into a repository. For more information, see [ChartMuseum](../01-prereq/chartmuseum).
