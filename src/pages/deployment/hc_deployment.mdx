...
docker run --rm -e LICENSE=view ibmcom/websphere-liberty:22.0.0.6-full-java8-ibmjava-ubi
...
The `helm install` command shows all the Kubernetes objects and also runs the Merative Social Program Management (SPM) containers.
