...
| ![SPM 8.1.0.0](https://img.shields.io/badge/-SPM_8.1.0.0-green) `xmlserver.livenessProbe.initialDelaySeconds` | Configure the number of seconds after container startup to initiate the probe | `60` |
| ![SPM 8.1.0.0](https://img.shields.io/badge/-SPM_8.1.0.0-green) `xmlserver.livenessProbe.periodSeconds` | Configure the number of seconds between probe invocations | `120` |
| ![SPM 8.1.0.0](https://img.shields.io/badge/-SPM_8.1.0.0-green) `xmlserver.livenessProbe.timeoutSeconds` | Configure the number of seconds before the probe times out | `30` |
