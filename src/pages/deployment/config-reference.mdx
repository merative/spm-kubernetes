...
| `xmlserver.jvm.maxMemory` | The maximum Java heap for the XML server | `-Djava.maxmemory=768m` |
| `xmlserver.jvm.threadStackSize` | The Java thread stack size for the XML server | `-Djava.thread.stack.size=-Xss4m` |
