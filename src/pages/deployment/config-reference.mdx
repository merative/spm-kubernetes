...
| `apps.tuningDefaults.coreThreads` | Minimum number of threads to associate with the [executor](https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.liberty.autogen.base.doc/ae/rwlp_config_executor.html) | `4` |
| `apps.tuningDefaults.maxThreads` | Maximum number of threads that can be associated with the [executor](https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.liberty.autogen.base.doc/ae/rwlp_config_executor.html) | `4` |
| `apps.tuningDefaults.maxPoolSize` | Maximum number of physical connections for a [pool](https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.liberty.autogen.base.doc/ae/rwlp_config_connectionManager.html) | `8` |
| `apps.tuningDefaults.numConnectionsPerThreadLocal` | Number of connections to be cached for each thread | `2` |
| `apps.tuningDefaults.purgePolicy` | Specifies which connections to destroy when a stale connection is detected in a [pool](https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.liberty.autogen.base.doc/ae/rwlp_config_connectionManager.html) | `EntirePool` |
| `apps.tuningDefaults.statementCacheSize` | Maximum number of cached statements per [connection](https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.liberty.autogen.base.doc/ae/rwlp_config_dataSource.html) | `1000` |
...
[bulk reassessment of all open integrated cases](https://www.ibm.com/support/knowledgecenter/SS8S5A_7.0.10/com.ibm.curam.content.doc/HCRDeveloper/t_HCR_Batch_Runningbulkreassessmentallopenintegratedcases.html)
