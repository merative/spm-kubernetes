...
When you follow the steps "Kubernetes dashboard" in [Monitoring the application](/08-runtime/interrogate_runtime), the `minikube dashboard` command might not work on Red Hat operating systems.
