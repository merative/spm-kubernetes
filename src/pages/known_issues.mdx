...
When you follow the steps "Kubernetes dashboard" in [Monitoring the application in Minikube](../05-runtime/interrogate_runtime), the `minikube dashboard` command might not work on Red Hat operating systems.
For more information, see [Minikube issue](https://github.com/kubernetes/minikube/issues/5815).
