...
<AccordionItem title="Can we host SPM on Amazon Elastic Kubernetes Services (EKS) or IBM Cloud Kubernetes Services (IKS)?">
No. SPM only supports hosting of containerized architectures on Azure Kubernetes Services or OpenShift.

SPM provided multi-cloud support through OpenShift in 2020; this means that SPM will support Docker containers hosted on any cloud provider (i.e. AWS, Azure, etc) or on-premises,
...
**Important**:
SPM does not support WebSphere Liberty hosted directly on a virtual machine or bare metal, outside of Kubernetes or OpenShift.
