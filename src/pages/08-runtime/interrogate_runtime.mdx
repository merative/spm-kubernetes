...
* View the Minikube dashboard/CodeReady Containers console
...
An example of the Minikube dashboard:
...
If you wish to view the credentials for `kube:admin` or `developer` simply run the following command:

```shell
crc console --credentials
```

An example of the CodeReady Containers console:
