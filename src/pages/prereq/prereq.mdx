...
| OpenShift ![OpenShift only](https://img.shields.io/badge/-OpenShift_only-red)   | 4.6 and future fix packs  | 4.6                   | 8,12        |
| Kubernetes ![IKS only](https://img.shields.io/badge/-IKS_only-blue)             | 1.19 and future fix packs | 1.19                  | 2,11        |
| IBM MQ LTS                                                                      | 9.2                       | 9.2.0.2 and future FP | 3           |
...
|`(10)` &#124; Support for Docker 20.10 was introducted as part of the SPM@Kubernetes 21.2.0 release.|
