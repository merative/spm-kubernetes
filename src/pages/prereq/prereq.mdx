...
| Kubernetes ![IKS only](https://img.shields.io/badge/-IKS_only-blue)             | 1.20 and future fix packs | 1.20                  | 2,12        |
...
|`(15)` &#124; From Helm release `v3.7.0`, the ChartMuseum Push plugin to be used with IBM Cúram Social Program Management must be version `0.10.0` or greater|
...
| Kubernetes                    | 1.20 and future fix packs | 1.20                  | 2,8,9       |
