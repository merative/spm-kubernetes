...
This page covers some common CRC operations, including deploying Merative Social Program Management (SPM) to the CRC environment. You will use the Helm Charts produced in [Preparing Helm Charts](/deployment/hc_deployment).
...
There is a known CRC [issue](https://github.com/crc-org/crc/issues/557) with respect to resource usage. When deploying SPM on CRC our experience has shown that a minimum of 16GB will improve performance, however 32GB is optimal.
