...
Cúram JMX statistics provides operational data from a running Merative Social Program Management (SPM) application.
JMX statistics for use with a traditional application server are documented
in this [IBM Documentation](https://www.ibm.com/docs/en/spm/8.0.2?topic=management-configuring-jmx-statistics) page.

### Cúram JMX Kubernetes Limitations

Cúram JMX statistics behave similarly in Kubernetes, but have the following limitations:

* Access by using the [SPM Administration Application](https://www.ibm.com/docs/en/spm/8.0.2?topic=statistics-using-administration-application)
...
Therefore, for Kubernetes you are restricted to using the timer-based access method, for more information, see [Using the JMX Timer](https://www.ibm.com/docs/en/spm/8.0.2?topic=statistics-using-jmx-timer).
