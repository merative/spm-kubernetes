...
This option is only available in SPM V8.0.1 or higher as described in the [XML Server Configuration Reference](/deployment/config-reference#xml-server) topic
