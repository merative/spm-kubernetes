...
Monitoring of the XML server is available for:

* The XML server via its statistics, described in [Monitoring XML server statistics](#monitoring-xml-server-statistics)
