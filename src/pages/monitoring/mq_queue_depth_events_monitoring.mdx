...
A wide variety of metrics for the IBM MQ queue manager exist
such as documented in the
[Knowledge Center](https://www.ibm.com/docs/en/ibm-mq/9.2?topic=containers-metrics-published-by-mq-certified).
