...
* [Collecting MustGather data for SPM on Kubernetes](#collecting-mustgather-data-for-spm-on-kubernetes)
...
* [Build systems](#build-systems)
  ...
  * [SPM and base third party software versions](#spm-and-base-third-party-software-versions)
...
* [Additional log files and artifacts](#additional-log-files-and-artifacts)
  ...
  * [HTTP Server logs and artifacts](#http-server-logs-and-artifacts)
  * [LDAP](#ldap)
...
Include this information for the relevant platform where you build Cúram SPM.
...
**Note:** Both of the above command formats produce the following spurious, benign error which you can ignore:
...
where the number of pods may vary depending on the Cúram SPM applications deployed.
...
[Configuring the XML server](https://www.ibm.com/support/knowledgecenter/SS8S5A_7.0.10/com.ibm.curam.content.doc/XMLInfrastructure/c_XMLINF_Server1ConfiguringXmlServer1.html),
