...
Note, WebSphere® Liberty will not start the Cúram application until the remote debugger attaches to the listener. Therefore, the log will not be populated before you launch the remote debugger.
