---
title: SPM Kubernetes cluster application architecture
description: SPM Kubernetes cluster application architecture
---

## SPM Kubernetes cluster application architecture

The application architecture overview in this section is represents how SPM should be deployed in to IKS.  
...
* SPM only support SPM Docker container when deployed into Kubernetes pods.
