...
**Note:** For more infomation about how to create an SPM static content container to run on Kubernetes, see [Building the Docker® images](../02-build-images/build_images)
