...
```powershell
unzip -qd $env:TMP $env:SPM_HOME\dockerfiles\Liberty\content\apache-ant-1.10.6-bin.zip
$env:ANT_HOME = "$env:TMP\apache-ant-1.10.6"
```
...
docker run --rm \
    ...
    ibmcom/websphere-liberty:24.0.0.6-full-java8-ibmjava-ubi \
