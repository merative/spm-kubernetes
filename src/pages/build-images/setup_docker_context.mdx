...
1. Download the IBM MQ resource adapter from Fix Central.
   ...
   1. Find the resource adapter for your version of IBM MQ in the displayed list of available fixes. For example:
    ...
    1. Then click the resource adapter file name and follow the download process.
