...
1. Download the IBM MQ resource adapter from Fix Central.
   1. Click this link: [IBM MQ Resource Adapter](https://ibm.biz/mq91cdRA)
   2. Find the resource adapter for your version of IBM MQ in the displayed list of available fixes. For example:
    ...
    3. Then click the resource adapter file name and follow the download process.
