...
To install the WebSphere Liberty fix pack by using Installation Manager, download and install Installation Manager 1.9 or later from the [IBM Installation Manager download website](https://www.ibm.com/support/pages/installation-manager-and-packaging-utility-download-documents).
...
WebSphere Liberty 19.0.0.12 is the only application server that supports SPM on Kubernetes and is therefore required. Download and install WebSphere Liberty 19.0.0.12.
...
* [19.0.0.12 Fix Pack](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm%2FWebSphere&product=ibm/WebSphere/WebSphere+Liberty&release=All&platform=All&function=fixId&fixids=19.0.0.12-WS-LIBERTY-*-FP&includeRequisites=1&includeSupersedes=0&downloadMethod=http)
