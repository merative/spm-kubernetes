...
* *dockerfiles:* Contains the Docker® files and other artifacts that are used to generate the SPM containers. For more information, see [Setting up the Docker context](/03-build-images/setup_docker_context).
* *helm-charts:* Contains the charts that are used to deploy the SPM containers on Kubernetes. For more information, see [Preparing Helm Charts](/04-deployment/hc_preparation).
