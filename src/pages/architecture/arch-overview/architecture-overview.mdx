...
containers, orchestrated by Helm, and running on Red Hat OpenShift or IKS.
...
* [Message Architecture](https://www.ibm.com/docs/en/spm/8.0.2?topic=architecture-messaging)
...
* [Transaction Isolation](https://www.ibm.com/docs/en/spm/8.0.2?topic=architecture-transaction-isolation)
...
* [Elasticity](https://www.ibm.com/docs/en/spm/8.0.2?topic=architecture-elasticity)
