...
* [Message Architecture](https://www.ibm.com/docs/en/spm/8.0.1?topic=architecture-messaging)
...
* [Transaction Isolation](https://www.ibm.com/docs/en/spm/8.0.1?topic=architecture-transaction-isolation)
...
* [Elasticity](https://www.ibm.com/docs/en/spm/8.0.1?topic=architecture-elasticity)
