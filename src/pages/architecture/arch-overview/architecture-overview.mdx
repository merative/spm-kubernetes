...
* [Message Architecture](https://www.ibm.com/docs/en/spm/7.0.11?topic=architecture-messaging)
...
* [Transaction Isolation](https://www.ibm.com/docs/en/spm/7.0.11?topic=architecture-transaction-isolation)
...
* [Elasticity](https://www.ibm.com/docs/en/spm/7.0.11?topic=architecture-elasticity)
