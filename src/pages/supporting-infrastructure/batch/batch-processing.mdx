...
The pod runs the standard command `build.sh runbatch` that is described in [Running the Batch Launcher](https://www.ibm.com/support/knowledgecenter/SS8S5A_7.0.10/com.ibm.curam.content.doc/Operations/c_COPSGUIDE_Processes2RunningBatchLauncher1.html).
