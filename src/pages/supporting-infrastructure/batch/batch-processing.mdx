...
The pod runs the standard command `build.sh runbatch` that is described in [Running the Batch Launcher](https://www.ibm.com/docs/en/spm/7.0.11?topic=launcher-running-batch).
