...
Liberty persistent timers are configured by default to support the [SPM timer infrastructure](https://www.ibm.com/docs/en/spm/8.0.1?topic=behavior-cram-timer).
