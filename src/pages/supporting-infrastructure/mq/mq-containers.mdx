...
5. Pull the IBM MQ docker image.
    ...
    ```
    docker pull cp.icr.io/cp/ibm-mqadvanced-server:9.1.5.0-r2-amd64
    ```

    The following output should be displayed:

    ```
    9.1.5.0-r2-amd64: Pulling from cp/ibm-mqadvanced-server
    (...)
    Status: Downloaded newer image for cp.icr.io/cp/ibm-mqadvanced-server:9.1.5.0-r2-amd64
