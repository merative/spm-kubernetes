...
Merative Social Program Management (SPM) can be integrated with [IBM Security Access Manager](https://www.ibm.com/docs/en/sva/9.0.7) (ISAM) to enable single sign-on (SSO) authentication.
