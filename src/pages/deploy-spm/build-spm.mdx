...
**Note:** For more information, see Static Content Server in the [IBM Documentation](https://www.ibm.com/docs/en/spm/8.0.1?topic=configuration-static-content-server)
