...
**Note:** For more information, see Static Content Server in the [IBM Documentation](https://www.ibm.com/docs/en/spm/8.0.2?topic=configuration-static-content-server)
