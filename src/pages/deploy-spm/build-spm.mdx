...
**Note:** For more information, see Static Content Server in the [IBM Documentation](https://www.ibm.com/docs/en/spm/7.0.11?topic=configuration-static-content-server)
