...
The Merative Social Program Management (SPM) release that supports deployment to Kubernetes requires running a full SPM 8.1.0.0 platform installer, which you can download from [Merative Support](https://merative.my.site.com/mysupport/s/).
