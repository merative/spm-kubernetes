...
* [Install prerequisite software](01-PREREQ/prereq.md)
  ...
  * [GitHub repo](01-PREREQ/git.md)
  * [Known Issues](01-PREREQ/known_issues.md)

## Building the IBM Cúram Social Program Management application

* [Building The Cúram Social Program Management application](01-PREREQ/spm-build.md)

## Building Docker images

* [Setting up the Docker context](02-BUILD-CONTAINERS/build_docker.md)
* [Building the Docker images](02-BUILD-CONTAINERS/build_docker2.md)

## Deploying with Helm Charts

* [Preparing Helm charts](03-DEPLOYMENT/hc_preparation.md)
* [Deploying Helm charts](03-DEPLOYMENT/hc_deployment.md)

## Monitoring and troubleshooting

* [Monitor the application in Minikube](04-RUNTIME/interrogate_runtime.md)
